...
// Rasterize directly from the five canonical design/brand SVGs. Keeping path data
...
// the terrarium renderer so ESP32 draws the canonical five agent silhouettes.
#pragma once
#include <cstdint>
