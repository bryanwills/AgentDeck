...
| **Apple App Store** — macOS + iPhone/iPad | `apple-v*` | [1.0.8 live on both platforms](https://apps.apple.com/app/id6784822497) (build 5301, released 2026-08-22). **1.2.0 submitted for review on both platforms 2026-09-02** — build 5801 each, en/ko/ja release notes, one submission click per platform as ASC requires. `apple-v1.1.0` produced no build (GitHub-side outage window on 2026-08-26); its content ships in 1.2.0 |
| **Elgato Marketplace** — Stream Deck plugin | `streamdeck-v*` | [1.0.6 live](https://marketplace.elgato.com/product/agentdeck-dce3806b-176e-40f2-be7d-e029bec0f464) (published 2026-08-18). **1.2 pending review** — uploaded 2026-09-02 with auto-publish off, so the DRM-processed build's encoders get the review-loop check before going live |
| **Ulanzi Marketplace** — D200H / D200X plugin | `ulanzi-v*` | [1.0.3 live](https://ugc.ulanzistudio.com/contentView/1141), **1.2.0 under review** — the pending review record (submitted as 1.0.4, silently replaced in review by 1.0.5) was edited in place to 1.2.0 on 2026-09-02 with the full seven-language copy restored and `Dial` deselected again; the portal answered "Review work updated" and 1.0.3 keeps serving meanwhile ([details](marketplace/ulanzi/LISTING.md)) |
...
| **Google Play** — Android AAB | `android-v*` | [1.0.10 live](https://play.google.com/store/apps/details?id=dev.agentdeck) (versionCode 12, published 2026-08-19 at 100% across 177 countries). **1.2.0 (versionCode 15) in Google review** — production release submitted 2026-09-02 with en/ko notes, console reads "검토 중인 변경사항". Listing copy, assets and the console runbook are in [marketplace/play/](marketplace/play/LISTING.md) |
