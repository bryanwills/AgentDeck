...
| **GitHub Release** — Android APK | `android-v*` | 1.0.2 release prepared; [1.0.1](https://github.com/puritysb/AgentDeck/releases/tag/android-v1.0.1) remains latest until publishing |
