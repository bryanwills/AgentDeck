...
| **Apple App Store** — macOS + iPhone/iPad | `apple-v*` | [1.0.7 live on both platforms](https://apps.apple.com/app/id6784822497) — build 5201, iPhone/iPad released 2026-08-18 and macOS 2026-08-19 (each verified against the store's own record, not the approval mail) |
