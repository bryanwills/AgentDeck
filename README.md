...
| **Apple App Store** — macOS + iPhone/iPad | `apple-v*` | **iPhone/iPad 1.2.0 live** (build 5801, released 2026-09-02T07:12Z per Apple's lookup API). **macOS 1.2.0 (5801) waiting for review** after a same-day rejection (2.3.10 What's New named Android; 5.2.5 asked for physical-Mac proof of the WeatherKit mark — root cause was the App ID's WeatherKit App Services toggle, fixed without a new binary, see RELEASING.md) and a resubmission on 2026-09-03; [macOS 1.0.8 keeps serving](https://apps.apple.com/app/id6784822497?platform=mac) meanwhile. `apple-v1.1.0` produced no build (GitHub-side outage window on 2026-08-26); its content ships in 1.2.0 |
